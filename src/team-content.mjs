...
export const TEAM_MEMBERS = [
  {id:"difei",name:"狄菲",role:"助理／護衛",unlockDay:1,cost:0,ability:"physique",recruitable:false,art:"assets/images/characters/difei-portrait-v2.webp",summary:"二十歲的前國家級格鬥選手。她以助理身分整理情報，也會在最危險的距離保護老闆。",bonuses:{brawl:4,hp:6}},
