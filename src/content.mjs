import { EXTRA_MARKET_CHOICES } from "./market-content.mjs?v=19";
...
export const EVENTS = [
  ...
  event("asset_market",1,"前往市場購買","拜訪掮客老六，從房產、車輛、武器、物品、奢侈品與產業中挑選一項購買。所有裝備與產業都會實際改變戰鬥、報酬或每日收入。","功能卡",[
    ...
    choice("vehicle","購買改裝轎跑","現金 22／取得車輛「灰影轎跑」；戰場護甲 +3、撤離 +5，但需要保養。",[{type:"resource.add",value:-22},{type:"asset.grant",category:"vehicles",assetId:"vehicle_grey_sport",name:"灰影轎跑",armor:3,bonuses:{flee:5},description:"高速撤離用的改裝轎跑。"},{type:"ability.add",key:"engineering",value:3},{type:"stat.add",key:"stress",value:-3},{type:"world.add",key:"people",value:1}],undefined,"灰影轎跑掛著無法追溯的外地車牌。它能在追捕中提供更好的撤離機會，但醒目的引擎聲也會讓整條街知道你回來了。",22),
    choice("suv","購買二手越野休旅","現金 18／取得車輛「黑石休旅」；戰場護甲 +7、撤離 +2，適合載運隊員。",[{type:"resource.add",value:-18},{type:"asset.grant",category:"vehicles",assetId:"vehicle_black_suv",name:"黑石休旅",armor:7,bonuses:{flee:2},description:"能載運整支小隊並撞開路障的耐用休旅。"},{type:"ability.add",key:"physique",value:2},{type:"stat.add",key:"health",value:3},{type:"world.add",key:"people",value:-1}],undefined,"黑石休旅跑不快，卻能撞開路障、塞進四個人和三只現金袋。前任車主留下的彈孔被若琳用貼紙蓋住。",18),
    choice("weapon","購買短管霰彈槍","現金 14／取得武器「短管霰彈槍」；武器火力 6、格鬥傷害 +2，也會提高警方戒備。",[{type:"resource.add",value:-14},{type:"asset.grant",category:"weapons",assetId:"weapon_sawed_shotgun",name:"短管霰彈槍",combatPower:6,bonuses:{brawl:2},description:"近距離威力強大的易攜霰彈槍。"},{type:"ability.add",key:"reflex",value:3},{type:"stat.add",key:"stress",value:3},{type:"world.add",key:"security",value:5}],undefined,"老六把磨掉序號的霰彈槍交給你。近距離沒人敢擋路，但只要被搜到一次，普通臨檢就會變成重罪逮捕。",14),
    choice("pistol","購買消音手槍","現金 18／取得武器「九毫米消音手槍」；武器火力 5、射擊傷害 +2，警方戒備較低。",[{type:"resource.add",value:-18},{type:"asset.grant",category:"weapons",assetId:"weapon_silenced_pistol",name:"九毫米消音手槍",combatPower:5,bonuses:{attack:2},description:"便於隱藏且彈道紀錄乾淨的消音手槍。"},{type:"ability.add",key:"reflex",value:2},{type:"ability.add",key:"perception",value:1},{type:"stat.add",key:"stress",value:2},{type:"world.add",key:"security",value:2}],undefined,"這把槍乾淨、平衡，而且沒有在任何案件裡留下彈道紀錄。老六只提醒你，安靜的武器通常會讓人更快跨過底線。",18),
